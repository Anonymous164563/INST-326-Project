...
The calc_value function examines the values entered in the box that stores the expression in x to determine whether it should be calculated or displayed in the graph.
